...
class SimulateStep : public BaseAction {
    ...
    private:
        ...
        void processPendingOrders(WareHouse &wareHouse);
        void decrease(WareHouse &wareHouse);
        void processCompletedOrders(WareHouse &wareHouse); 
        void removeFinishedVolunteers(WareHouse &wareHouse);
